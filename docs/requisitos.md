...
O sistema deve informar quantas pessoas estão à frente do paciente.

04 — Estimativa de tempo
...
O aplicativo deve possuir uma interface simples e fácil de utilizar.

02 — Desempenho

O sistema deve atualizar as informações da fila rapidamente.

03 — Segurança

O sistema deve proteger os dados dos pacientes contra acessos não autorizados.
